      ...
      <div>
        <div className="cred-card">
          ...
          <div className="cc-row">
            <div className="ic"><img src={A.i0} alt="" className="i3m" decoding="async" /></div>
            <div className="tx"><small>Tên pháp lý</small><b>Công ty TNHH Đầu tư Xây dựng & Thiết bị Công nghệ HPT</b></div>
          </div>
          <div className="cc-row">
            <div className="ic"><img src={A.i1} alt="" className="i3m" decoding="async" /></div>
            <div className="tx"><small>Trụ sở chính</small><b>SB04 Vinhomes Marina, P. An Biên, TP. Hải Phòng</b></div>
          </div>
          <div className="cc-row">
            <div className="ic"><img src={A.i2} alt="" className="i3m" decoding="async" /></div>
            <div className="tx"><small>Mã số thuế</small><b>0202253444</b></div>
          </div>
          <div className="cc-row">
            <div className="ic"><img src={A.i3} alt="" className="i3m" decoding="async" /></div>
...
<section className="about" id="ve-chung-toi">
  <div className="wrap about-grid">
    ...
    <div className="about-media reveal">
      <img src={A.i4} alt="Trụ sở và đội ngũ HPT Technology tại Vinhomes Marina, Hải Phòng" width="1600" height="1312" decoding="async" />
    </div>
  </div>
</section>
...
<section className="sec tint" id="khach-hang">
  <div className="wrap">
    ...
    <div className="sector-grid reveal">
      <div className="sector"><div className="si"><img src={A.i5} alt="Huy hiệu Đảng Cộng sản Việt Nam" decoding="async" /></div><b>Cơ quan Đảng</b></div>
      <div className="sector"><div className="si"><img src={A.i6} alt="Quốc huy nước CHXHCN Việt Nam" decoding="async" /></div><b>Cơ quan hành chính nhà nước</b></div>
      <div className="sector"><div className="si"><img src={A.i7} alt="Logo Bộ Khoa học và Công nghệ" decoding="async" /></div><b>Bộ, ban, ngành & đơn vị trực thuộc</b></div>
      <div className="sector"><div className="si"><img src={A.i8} alt="Công an hiệu" decoding="async" /></div><b>Công an & lực lượng vũ trang</b></div>
      <div className="sector"><div className="si"><img src={A.i9} alt="Logo Bộ Y tế" decoding="async" /></div><b>Bệnh viện & cơ sở y tế</b></div>
      <div className="sector"><div className="si"><img src={A.i10} alt="Logo Bộ Giáo dục và Đào tạo" decoding="async" /></div><b>Trường đại học, cao đẳng & giáo dục</b></div>
      <div className="sector"><div className="si"><img src={A.i11} alt="Logo Tập đoàn Điện lực Việt Nam EVN" decoding="async" /></div><b>Điện lực & doanh nghiệp nhà nước</b></div>
      <div className="sector"><div className="si"><img src={A.i12} alt="Logo Tổng công ty Cảng hàng không Việt Nam ACV" decoding="async" /></div><b>Cảng biển, logistics & giao thông</b></div>
      <div className="sector"><div className="si"><img src={A.i13} alt="Huy hiệu Bộ Tài chính" decoding="async" /></div><b>Ngân hàng & tổ chức tài chính</b></div>
      <div className="sector"><div className="si"><img src={A.i14} alt="Logo Liên đoàn Thương mại và Công nghiệp Việt Nam VCCI" decoding="async" /></div><b>Doanh nghiệp SX, thương mại & dịch vụ</b></div>
    </div>
  </div>
</section>
  ...
  <div className="wrap">
    <div className="life">
      <div className="life-card reveal">
        ...
        <span className="tag"><img src={A.i15} alt="" style={{width:'16px',height:'16px'}} decoding="async" /> Triển khai tổng thể — trọn vòng đời dự án</span>
      </div>
      <div className="reveal">
  ...
  <div className="wrap">
    ...
    <div className="domain-grid reveal">
      <div className="domain">
        <div className="dh"><div className="di"><img src={A.i16} alt="Icon máy tính — hạ tầng CNTT" decoding="async" /></div>
      ...
      <div className="domain">
        <div className="dh"><div className="di"><img src={A.i17} alt="Icon anten vệ tinh — hạ tầng mạng viễn thông" decoding="async" /></div>
      ...
      <div className="domain accent-r">
        <div className="dh"><div className="di"><img src={A.i18} alt="Icon lá chắn — an toàn thông tin" decoding="async" /></div>
      ...
      <div className="domain">
        <div className="dh"><div className="di"><img src={A.i19} alt="Icon máy in — in ấn và số hóa" decoding="async" /></div>
      ...
      <div className="domain accent-g">
        <div className="dh"><div className="di"><img src={A.i20} alt="Icon camera — giám sát thông minh" decoding="async" /></div>
      ...
      <div className="domain">
        <div className="dh"><div className="di"><img src={A.i21} alt="Icon màn hình — hội nghị truyền hình" decoding="async" /></div>
...
<section className="sec dark">
  <div className="wrap">
    ...
    <div className="soft-grid reveal">
      <div className="soft">
        <div className="sh"><div className="sic"><img src={A.i22} alt="" className="i3s" decoding="async" /></div><h3>Website & cổng thông tin điện tử</h3></div>
      ...
      <div className="soft">
        <div className="sh"><div className="sic"><img src={A.i23} alt="" className="i3s" decoding="async" /></div><h3>Phát triển ứng dụng công nghệ</h3></div>
      ...
      <div className="soft feature">
        <div className="inner">
          <div>
            <div className="sh"><div className="sic" style={{background:'rgba(0,162,74,.22)',borderColor:'rgba(57,217,138,.4)',color:'#39d98a'}}><img src={A.i24} alt="" className="i3s" decoding="async" /></div><h3>Phần mềm phòng họp không giấy</h3></div>
      ...
      <div className="soft wide">
        <div className="sh"><div className="sic"><img src={A.i25} alt="" className="i3s" decoding="async" /></div><h3>Phần mềm quản lý theo nghiệp vụ</h3></div>
...
<section className="sec tint" id="du-an">
  <div className="wrap">
    ...
    <div className="proc reveal">
      <div className="pstep"><div className="pn"><span className="pnum">1</span><img src={A.i26} alt="" className="i3p2" decoding="async" /></div><b>Khảo sát</b><small>Thu thập yêu cầu & hiện trạng</small></div>
      <div className="pstep"><div className="pn"><span className="pnum">2</span><img src={A.i27} alt="" className="i3p2" decoding="async" /></div><b>Tư vấn giải pháp</b><small>Phân tích & lựa chọn công nghệ</small></div>
      <div className="pstep"><div className="pn"><span className="pnum">3</span><img src={A.i28} alt="" className="i3p2" decoding="async" /></div><b>Thiết kế & kế hoạch</b><small>Thiết kế kỹ thuật, tiến độ</small></div>
      <div className="pstep"><div className="pn"><span className="pnum">4</span><img src={A.i29} alt="" className="i3p2" decoding="async" /></div><b>Cung cấp & triển khai</b><small>Lắp đặt, cấu hình, tích hợp</small></div>
      <div className="pstep"><div className="pn"><span className="pnum">5</span><img src={A.i30} alt="" className="i3p2" decoding="async" /></div><b>Kiểm thử & nghiệm thu</b><small>Chạy thử, đánh giá, bàn giao</small></div>
      <div className="pstep"><div className="pn"><span className="pnum">6</span><img src={A.i31} alt="" className="i3p2" decoding="async" /></div><b>Đào tạo & chuyển giao</b><small>Hướng dẫn vận hành, tài liệu</small></div>
      <div className="pstep"><div className="pn"><span className="pnum">7</span><img src={A.i32} alt="" className="i3p2" decoding="async" /></div><b>Bảo hành & hỗ trợ</b><small>Bảo trì suốt vòng đời hệ thống</small></div>
    </div>
  </div>
</section>
...
<section className="sec" id="doi-tac">
  <div className="wrap">
    ...
    <div className="partner-grid reveal">
      <div className="partner"><img src={A.i33} alt="Dell Technologies" decoding="async" /></div>
      <div className="partner"><img src={A.i34} alt="Hewlett Packard Enterprise" decoding="async" /></div>
      <div className="partner"><img src={A.i35} alt="Lenovo" decoding="async" /></div>
      <div className="partner"><img src={A.i36} alt="Hikvision" decoding="async" /></div>
      <div className="partner"><img src={A.i37} alt="Dahua Technology" decoding="async" /></div>
      <div className="partner"><img src={A.i38} alt="Fortinet" decoding="async" /></div>
      <div className="partner"><img src={A.i39} alt="Cisco" decoding="async" /></div>
      <div className="partner"><img src={A.i40} alt="Aruba — a HPE company" decoding="async" /></div>
      <div className="partner"><img src={A.i41} alt="Microsoft" decoding="async" /></div>
      <div className="partner"><img src={A.i42} alt="VMware" decoding="async" /></div>
      <div className="partner"><img src={A.i43} alt="Veeam" decoding="async" /></div>
      <div className="partner"><img src={A.i44} alt="Canon" decoding="async" /></div>
      <div className="partner"><img src={A.i45} alt="Fujitsu" decoding="async" /></div>
      <div className="partner"><img src={A.i46} alt="Synology" decoding="async" /></div>
      <div className="partner"><img src={A.i47} alt="QNAP" decoding="async" /></div>
    </div>
...
<section className="sec tint">
  <div className="wrap">
    ...
    <div className="commit-grid reveal">
      ...
      <div className="commit" style={{background:'linear-gradient(135deg,var(--navy-2),var(--navy-deep))',border:'0'}}><span className="ck" style={{background:'rgba(255,255,255,.15)'}}><img src={A.i48} alt="" style={{width:'20px',height:'20px'}} decoding="async" /></span><span style={{color:'#fff'}}>11 cam kết cho mỗi dự án</span></div>
    </div>
  </div>
</section>
  ...
  <div className="wrap">
    ...
    <div className="vm-grid reveal">
      <div className="vm vision">
        <div className="vmi"><img src={A.i49} alt="" className="i3v" decoding="async" /></div>
        <h3>Tầm nhìn</h3>
      ...
      <div className="vm mission">
        <div className="vmi"><img src={A.i50} alt="" className="i3v" decoding="async" /></div>
        <h3>Sứ mệnh</h3>
    ...
    <div className="cta-inner reveal">
      <div className="txt">
        ...
        <div className="cta-contacts">
          <a className="cc-item" href="tel:0967286889"><img src={A.i51} alt="" /><span><small>Hotline tư vấn</small><b>0967 286 889</b></span></a>
          <a className="cc-item" href="mailto:info@hpttech.vn"><img src={A.i52} alt="" /><span><small>Email</small><b>info@hpttech.vn</b></span></a>
          <div className="cc-item"><img src={A.i53} alt="" /><span><small>Giờ làm việc</small><b>8:00 – 17:30 (T2–T7)</b></span></div>
        </div>
      </div>
