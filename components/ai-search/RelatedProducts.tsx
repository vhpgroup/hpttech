  ...
  return (
    <section className="rounded-lg border border-slate-200 bg-white p-4 shadow-sm md:p-5">
      <div className="mb-4 flex items-center justify-between gap-3">
        ...
        <Link href="/san-pham?category=Máy%20scan" className="inline-flex items-center gap-1 text-sm font-bold text-blue-700">
          Xem tất cả
          <ArrowRight size={16} />
        </Link>
      </div>
      ...
      <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6">
        {products.map((product) => (
          <article key={product.slug} className="rounded-lg border border-slate-100 bg-slate-50 p-3 transition hover:border-blue-200 hover:bg-blue-50/60">
            ...
            <h3 className="mt-3 line-clamp-2 min-h-[40px] text-sm font-bold leading-5 text-blue-700">
