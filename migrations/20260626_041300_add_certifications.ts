...
export async function up({ db }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
    ...
    CREATE TABLE IF NOT EXISTS "certifications" (
      ...
      "logo_id" integer,
      "scope" varchar,
      "territory" varchar DEFAULT 'Việt Nam',
    ...
    CREATE TABLE IF NOT EXISTS "_certifications_v" (
      ...
      "version_territory" varchar DEFAULT 'Việt Nam',
...
export async function down({ db }: MigrateDownArgs): Promise<void> {
  await db.execute(sql`
    ALTER TABLE "payload_locked_documents_rels" DROP CONSTRAINT IF EXISTS "payload_locked_documents_rels_certifications_fk";
    ...
    DROP TABLE IF EXISTS "_certifications_v_version_gallery" CASCADE;
    DROP TABLE IF EXISTS "_certifications_v" CASCADE;
    DROP TABLE IF EXISTS "certifications_gallery" CASCADE;
    DROP TABLE IF EXISTS "certifications" CASCADE;

    DROP TYPE IF EXISTS "public"."enum__certifications_v_version_status";
    DROP TYPE IF EXISTS "public"."enum__certifications_v_version_kind";
    DROP TYPE IF EXISTS "public"."enum_certifications_status";
