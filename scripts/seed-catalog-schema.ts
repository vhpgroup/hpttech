...
> = {
  scanner: {
    ...
    attributes: [
      { code: "scanner_scan_speed_simplex", label: "Tốc độ scan một mặt", dataType: "number", unit: "ppm", required: true, filterable: true },
      { code: "scanner_scan_speed_duplex", label: "Tốc độ scan hai mặt", dataType: "number", unit: "ipm", filterable: true },
      { code: "scanner_adf_capacity", label: "Sức chứa ADF", dataType: "number", unit: "sheets", required: true, filterable: true },
      { code: "scanner_duplex", label: "Scan hai mặt tự động", dataType: "boolean", unit: "none", required: true, filterable: true },
      {
