...
export const brandConfigs = [
  ...
  {
    aliases: ["viisan", "visualcam", "s21", "s48"],
    crawlMethod: "fetch",
    delayMs: 2000,
    domain: "viisan.com",
    extraDomains: ["viisan.com", "vietbis.vn"],
    name: "Viisan",
    slug: "viisan",
  },
  {
    aliases: ["czur", "et ultra", "et max", "m3000"],
    crawlMethod: "fetch",
    delayMs: 2000,
    domain: "czur.com",
    extraDomains: ["czur.com", "vietbis.vn"],
    name: "Czur",
    slug: "czur",
  },
  {
    aliases: ["visioneer", "xerox documate", "patriot"],
    crawlMethod: "fetch",
    delayMs: 2000,
    domain: "visioneer.com",
    extraDomains: ["visioneer.com", "xeroxscanners.com", "vietbis.vn"],
    name: "Visioneer",
    slug: "visioneer",
  },
  {
    aliases: ["mustek", "scanexpress", "a3f", "a3 2400s"],
    crawlMethod: "fetch",
    delayMs: 2000,
    domain: "mustek.com",
    extraDomains: ["mustek.com", "mustek.com.tw", "vietbis.vn"],
    name: "Mustek",
    slug: "mustek",
  },
  {
    aliases: ["contex", "iq flex", "hd ultra", "sd one"],
    crawlMethod: "fetch",
    delayMs: 2000,
    domain: "contex.com",
    extraDomains: ["contex.com", "vietbis.vn"],
    name: "Contex",
    slug: "contex",
  },
  {
    aliases: ["colortrac", "smartlf", "smartlf scan"],
    crawlMethod: "fetch",
    delayMs: 2000,
    domain: "colortrac.com",
    extraDomains: ["colortrac.com", "vietbis.vn"],
    name: "Colortrac",
    slug: "colortrac",
  },
  {
    aliases: ["rowe", "rowe mfp", "scan 450i"],
    crawlMethod: "fetch",
    delayMs: 2000,
    domain: "rowe.de",
    extraDomains: ["rowe.de", "vietbis.vn"],
    name: "ROWE",
    slug: "rowe",
  },
  {
    aliases: ["image access", "bookeye", "wideTEK", "widetek"],
    crawlMethod: "fetch",
    delayMs: 2000,
    domain: "imageaccess.de",
    extraDomains: ["imageaccess.de", "imageaccess.us", "vietbis.vn"],
    name: "Image Access",
    slug: "image-access",
  },
  {
    aliases: ["inotec", "scamax"],
    crawlMethod: "fetch",
    delayMs: 2000,
    domain: "inotec.eu",
    extraDomains: ["inotec.eu", "vietbis.vn"],
    name: "InoTec",
    slug: "inotec",
  },
  {
  ...
  {
    aliases: ["sma", "robo scan", "roboscan", "versascan"],
    crawlMethod: "fetch",
    delayMs: 2000,
    domain: "sma.de",
    extraDomains: ["sma.de", "vietbis.vn"],
    name: "SMA",
    slug: "sma",
  },
  {
    aliases: ["treventus", "scanrobot", "scanrobot 2.0"],
    crawlMethod: "fetch",
    delayMs: 2000,
    domain: "treventus.com",
    extraDomains: ["treventus.com", "vietbis.vn"],
    name: "TREVENTUS",
    slug: "treventus",
  },
  {
